...
?>
    <div class="mx-auto p-5">
        <div class="card">
            ...
            <b class="fs-4"><i class="fa-solid fa-circle-info"></i> Información del Grupo</b>   
            </div>
            <div class="card-body">
                <form action="" method="POST">
                    <div class="mb-3">
                        <label for="nombreGrupo" class="form-label">Nombre del grupo (ID: <?= $lstGrupo['idGrupo'] ?>)</label>
