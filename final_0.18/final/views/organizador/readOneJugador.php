        ...
        <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="txtNombreEquipo" id="nombreEquipo"  value="<?= $lstJugador['nombreEquipo'] ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <div class="colo-12">
                        <a href="readAllJugadores.php" class="btn btn-success">Regresar</a>
                    </div>
            </form>
        </div>
