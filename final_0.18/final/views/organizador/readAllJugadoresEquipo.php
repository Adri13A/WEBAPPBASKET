...
$rows = $objControlJ->readJugadoresEquipo($lstEquipo['nombreEquipo']);
?>
<div class="mx-auto p-5">
    <div class="card text-center">
        <div class="card-header">
            <b class="fs-4">
                <span> <i class="fa-solid fa-people-group"></i></span> Listado de los jugadores del equipo: <?= $lstEquipo['nombreEquipo'] ?>
            </b>
        </div>
        <div class="card-body">
                    ...
                    <?php if ($rows) : ?>
                        <?php foreach ($rows as $row) : ?>
                            <tr>
                                ...
                                <th>
                                    <a href="readOneJugadorEquipo.php?id=<?= $row['idJugador'] ?>" class="btn btn-primary"><span class="fa-solid fa-list-check"></span></a>
                                    <a href="updateJugadorEquipo.php?id=<?= $row['idJugador'] ?>" class="btn btn-success"><span class="fa-solid fa-pen-to-square"></span></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="deleteJugadorEquipo.php?id=<?= $row['idJugador'] ?>" class="btn btn-danger">Eliminar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="mx-auto p-3">
        <a href="equipo.php?id=<?= $_SESSION['idEquipo'] ?>" class="btn btn-primary">Regresar</a>
    </div>
</div>
