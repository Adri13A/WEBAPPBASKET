<?php
    ...
    $objControlE = new equiposController();
    //Capturar el id del torneo
    $lstJugador = $objControl->readOneJugador($_GET['id']); 
    $rows = $objControlE->readEquipos($_SESSION['idTorneo']);
            ...
            <form action="jugadorUpdate.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <?php
                         foreach ($rows as $row){
                            ...
                            if($nombreEquipo == $lstJugador['nombreEquipo'] ){
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <a href="readAllJugadores.php" class="btn btn-danger">Cancelar</a>
                    </div>  
            </form>
        </div>
