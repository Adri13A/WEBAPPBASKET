...
<div class="mx-auto p-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action="jugadorEquipoInsert.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="hidden" class="form-control" id="nombreEquipo" name="txtNombreEquipo" value="<?= $lstEquipo['nombreEquipo'] ?>">
                        <input type="hidden" class="form-control" id="idEquipo" name="txtIdEquipo" value="<?= $lstEquipo['idEquipo'] ?>">

                <div class="col mb-3">
                    <button type="submit" class ="btn btn-primary">Guardar</button>
                    <a href="equipo.php?id=<?= $lstEquipo['idEquipo'] ?>" class="btn btn-danger">Cancelar</a>
                </div> 
            </form>
        </div>
