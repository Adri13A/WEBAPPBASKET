...
<?php
    ...
    class jugadores{
        ...
        public function delete($idJugador){
            $consultaFoto = "SELECT fotoJugador from jugadores where idJugador = :id";
            $consulta = $this->PDO->prepare($consultaFoto);
            $consulta->bindParam(":id", $idJugador);
            $consulta->execute();
            while($eliminaFoto = $consulta->fetch()){
                    $fotoJugador= $eliminaFoto['fotoJugador'];
                    unlink($fotoJugador);
                    $fotoJugador="";
            }
        ...
        public function readJugadorEquipo($nombreEquipo){
            $statement = "SELECT * FROM jugadores where nombreEquipo = :nombreEquipo";
