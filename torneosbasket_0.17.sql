...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-01-2024 a las 01:01:34
...
INSERT INTO `equipos` (`idEquipo`, `nombreEquipo`, `logoEquipo`, `nombreResponsable`, `correoResponsable`, `celularResponsable`, `idGrupo`, `idTorneo`) VALUES
(1, 'test', 'test', 'test', 'test', 'test', 1, 0),
(2, 'asdas', 'asdas', 'asdas', 'asdas', 'adas', 2, 0);
...
--
-- Estructura de tabla para la tabla `juegosjugados`
--

CREATE TABLE `juegosjugados` (
  `idJuegosJugados` int(11) NOT NULL,
  `idEquipo1` int(11) NOT NULL,
  `idEquipo2` int(11) NOT NULL,
  `cantidadJuegos` int(11) NOT NULL,
  `idTorneo` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'Copa Altamirano', 'Nike, Samsung', 'Altamirano Suarez', 'Palo Alto', '20,000', '4,000', '1,000', 'Unos tacos y pal camion', 'Altamirano_Suarez', '$2y$10$eeITiVwvc63QuwW37Es1leYYsCYtD4qlb3zVJ2gG4dX6s4LC8IG2K');
...
--
-- Indices de la tabla `juegosjugados`
--
ALTER TABLE `juegosjugados`
  ADD PRIMARY KEY (`idJuegosJugados`),
...
--
-- AUTO_INCREMENT de la tabla `juegosjugados`
--
ALTER TABLE `juegosjugados`
  MODIFY `idJuegosJugados` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `juegosjugados`
--
ALTER TABLE `juegosjugados`
  ADD CONSTRAINT `juegosjugados_ibfk_1` FOREIGN KEY (`idEquipo1`) REFERENCES `equipos` (`idEquipo`),
  ADD CONSTRAINT `juegosjugados_ibfk_2` FOREIGN KEY (`idEquipo2`) REFERENCES `equipos` (`idEquipo`),
  ADD CONSTRAINT `juegosjugados_ibfk_3` FOREIGN KEY (`idTorneo`) REFERENCES `torneos` (`idTorneo`);
...
--
-- Filtros para la tabla `roldejuegos`
--
ALTER TABLE `roldejuegos`
  ADD CONSTRAINT `roldejuegos_ibfk_1` FOREIGN KEY (`idTorneo`) REFERENCES `torneos` (`idTorneo`),
  ADD CONSTRAINT `roldejuegos_ibfk_2` FOREIGN KEY (`idEquipo`) REFERENCES `equipos` (`idEquipo`),
  ADD CONSTRAINT `roldejuegos_ibfk_3` FOREIGN KEY (`idJugador`) REFERENCES `jugadores` (`idJugador`);
COMMIT;
