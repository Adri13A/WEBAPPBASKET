        ...
        <div class="card-body">
            <form action="torneoUpdate.php" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="txtId" id="idTorneo" value="<?= $lstTorneo['idTorneo'] ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="logoPatrocinadores" class="form-label">Logo(s) de Patrocinador(es)</label>
                    <input type="file" accept=".png, .jpg, .jpeg" name="txtImg" id="file" multiple>
                    <div class="mb-3 styleImage" id="preview"></div>
                </div>
                <!-- MANDAR A LLAMAR LAS  IMAGENES QUE DE LOS PATROCINADORES -->
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" class="form-control" id="premio1" name="txtPremio1" value="<?= $lstTorneo['premio1erLugar'] ?>">
                    </div>
                    <div class="col mb-3">
                        <label for="premio2" class="form-label">Premio 2do. Lugar</label>
                        <input type="text" class="form-control" id="premio2" name="txtPremio2" value="<?= $lstTorneo['premio2doLugar'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        <label for="premio3" class="form-label">Premio 3er. Lugar</label>
                        <input type="text" class="form-control" id="premio3" name="txtPremio3" value="<?= $lstTorneo['premio3erLugar'] ?>">
                    </div>
                    <div class="col mb-3">
