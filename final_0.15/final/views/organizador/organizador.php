...
<div class="mx-auto p-5">
    <div class="card text-center">
        <div class="card-header">
            ...
            <?php echo $_SESSION['nombreTorneo']; ?>
        </div>
        <div class="card-body">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <a href="frmGrupos.php" class="btn btn-primary">
                                <img src="../img/agregar.png" alt="Crear un grupo" width="180" height="180">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <a href="readAllGrupos.php" class="btn btn-primary">
                                <img src="../img/grupos.png" alt="Lista de los grupos" width="180" height="180">
                            </a>
                        </div>
                    </div>
                </div>
