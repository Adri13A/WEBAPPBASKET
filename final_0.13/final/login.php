...
<body>
    <div class="containerP">
        ...
        <div class="form-containerP">
            ...
            <form action="formulario.php" method="POST" class="mt-5">
                <div class="form-floating">
                    <input type="text" id="floatingInput" name="email" class="form-control"  placeholder="name@example.com" required>
                    <label for="floatingInput" class="">Correo</label>
                </div>

                <div class="form-floating mt-3">
                    <input type="password" id="floatingPassword" name="password" class="form-control"  placeholder="Contraseña" required>
