...
<div class="mx-auto p-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action="torneosInsert.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" accept=".png, .jpg, .jpeg" name="txtImg" id="file" multiple>
                ...
                <hr>
                <b>
                    <span></span><i class="fa-solid fa-user"></i></span> Crear usuario y contraseña para el organizador
                </b>
                <div class="row">
                    <div class="col mb-3">
