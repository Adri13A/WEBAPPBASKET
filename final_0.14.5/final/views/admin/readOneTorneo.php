                ...
                <form action="torneosInsert.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            value="<?= $lstTorneo['premio3erLugar'] ?>"readonly>
                        </div>
                        <div class="col mb-3">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            value="<?= $lstTorneo['usuarioOrganizador'] ?>"readonly>
                        </div>
                        <div class="col mb-3">
                            <label for="pass" class="form-label">Contraseña</label>
                            <input type="text" class="form-control" id="pass" name="txtPass" 
                            value="<?= $lstTorneo['contrasenaOrganizador'] ?>"readonly>
                        </div>
                    </div>
                    <div class="colo-12">
